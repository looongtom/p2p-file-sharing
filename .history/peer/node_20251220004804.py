...
class Node:
    ...
    def start_api(self, api_port: int = 5000) -> None:
        ...
        API endpoints:
        - POST /api/torrent/send - Share a file
        - GET /api/torrent/list - List files on tracker
        - POST /api/torrent/download - Download a file by filename or infohash
        - POST /api/exit - Gracefully exit
        """
        app = Flask(__name__)
